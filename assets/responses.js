...
exports.welcomeMessages = [
  ...
  "Hi! Waifu **{{user}}** has joined the Academy!",
...
exports.goodbyeMessages = [
  ...
  "Woah! **{{user}}** left the Academy! b-baka, Why did they even join?!",
...
exports.levelUpMessages = [
  ...
  "How can you be **{{level}}** y-you baka!",
...
exports.pingMessages = [
  ...
  "**{{user}}** Why are you ping’ing me man! You wasted **{{ms}}ms** of my time!!",
...
exports.levelMessages = [
  ...
  "**{{user}}**, again with this? Whatever, your level **{{level}}**.",
