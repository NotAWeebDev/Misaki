        ...
        let embed;   
            try {
                await fortnite.getInfo(args.splice(1).join(' '), args[0]).then(async data => {
                    ...
                    .addField('Matches', data.lifetimeStats[7], true)
                    .addField('Total Wins', data.lifetimeStats[8], true)
                    .addField('Win Rate', data.lifetimeStats[9], true)
                    .addField('Kills', data.lifetimeStats[10], true)
                    .addField('KDR', data.lifetimeStats[11], true)
                    .addField('Kills Per Minute', data.lifetimeStats[12], true)
                    .addField('Time Played', data.lifetimeStats[13], true)
                    .addField('Average Survival Time', data.lifetimeStats[14], true)
