...
class Bunny extends Social {
  ...
  async run(message, args, level, loadingMessage) {
    ...
    await loadingMessage.edit({embed:{ "title": "Click here if the image failed to load.", "url": body.media.gif, "color":message.guild.me.roles.highest.color || 5198940, "image": {"url": body.media.gif}}});
  }
}
